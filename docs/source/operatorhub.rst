...
When the operator is up and running install Sealed Secrets with the provided Custom Resource Definition under 
...
.. _OperatorHub.io: https://operatorhub.io/operator/sealed-secrets-operator-helm


OpenShift 4
-----------

In `OpenShift 4` navigate to :guilabel:`Administrator - Operators - OperatorHub` and install Sealed Secrets Operator (Helm).
When the operator is up and running install Sealed Secrets with the provided Custom Resource Definition under 
